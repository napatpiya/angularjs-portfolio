...
app.controller('myCtrl', function($scope, $http) {
    $http.get("http://3.14.142.119/angularjs-portfolio/wsdl.php?method=load_user")
        .then(function (response) {$scope.users = response.data.records;});
    $http.get("http://3.14.142.119/angularjs-portfolio/wsdl.php?method=load_menu")
        .then(function (response) {$scope.menus = response.data.records;});
    $http.get("http://3.14.142.119/angularjs-portfolio/wsdl.php?method=load_user1")
    ...
    $scope.submitMenu = function() {
        ...
        if (count === 0) {
            ...
            var request = $http({ 
                method: 'post',
                url: "http://3.14.142.119/angularjs-portfolio/insert_menu.php",
                data: {
    ...
    $scope.submitUser = function() {
        ...
        if (count === 0) {
            ...
            var request = $http({ 
            method: 'post',
            url: "http://3.14.142.119/angularjs-portfolio/update_user.php",
            data: {
    ...
    $scope.deleteMenu = function(menu_id) {
        ...
        var request = $http({ 
        method: 'post',
        url: "http://3.14.142.119/angularjs-portfolio/delete_menu.php",
        data: {
            id: menu_id
        },
        headers : {'Content-Type': 'application/x-www-form-urlencoded'} 
